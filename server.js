...
app.listen(PORT, () => {
  ...
  console.log('POST /test-print/test-print-direct – create order, pay, direct print (no print_event)');
  console.log('POST /test-print/real-menu-print   – order with real inventory items + print_event');
  ...
  console.log('GET  /test-print/items         – list sellable Clover inventory items');
  console.log('GET  /test-print/employees     – list Clover employees');
